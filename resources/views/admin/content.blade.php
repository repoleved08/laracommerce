                        ...
                        <div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="avatar me-3">
                                    <img src="admin/images/user/women_avatar5.jpg" class="rounded-circle"
                                        alt="image">
                                </div>
                                <div>
            ...
            <div class="card widget h-100">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3"
                                    src="admin/images/flags/united-states-of-america.svg" alt="...">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="admin/images/flags/venezuela.svg"
                                    alt="...">
                                <span>Venezuela</span>
                            </div>
                            <span>$1.064,75</span>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="admin/images/flags/salvador.svg"
                                    alt="...">
                                <span>Salvador</span>
                            </div>
                            <span>$1.055,98</span>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="admin/images/flags/russia.svg"
                                    alt="...">
                                <span>Russia</span>
                            </div>
                            <span>$1.042,00</span>
                        ...
                        <table class="table table-custom mb-0" id="recent-products">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="admin/images/products/10.jpg" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Cookie</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="admin/images/products/7.jpg" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Glass</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="admin/images/products/8.jpg" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Headphone</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="admin/images/products/9.jpg" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Perfume</td>
