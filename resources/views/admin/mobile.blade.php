                    ...
                    <div class="dropdown-menu-body">
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="admin/images/products/3.jpg" class="rounded" width="60"
                                        alt="...">
                                </a>
                                <div>
                                    <h6>Digital clock</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="admin/images/products/4.jpg" class="rounded" width="60"
                                        alt="...">
                                </a>
                                <div>
                                    <h6>Toy Car</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="admin/images/products/5.jpg" class="rounded" width="60"
                                        alt="...">
                                </a>
                                <div>
                                    <h6>Sunglasses</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="admin/images/products/6.jpg" class="rounded" width="60"
                                        alt="...">
                                </a>
                                <div>
                                    <h6>Cake</h6>
