                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                                                Created At</th>
                                            <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Option</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white">
                                        @foreach ($order as $order)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                                    <div class="text-sm leading-5 text-blue-900">{{ $order->email }}
                                                    </div>
                                                </td>
                                                <td
                                                ...
                                                <td
                                                    ...
                                                    <span
                                                        ...
                                                        <span
                                                            class="relative text-xs">{{ $order->payment_status }}</span>
                                                    </span>
                                                </td>
                                                <td
                                                    class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                                    <span
                                                        ...
                                                        <span aria-hidden
                                                            class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                                                        <span
                                                            class="relative text-xs">{{ $order->delivery_status }}</span>
                                                    </span>
                                                </td>
                                                <td
                                                ...
                                                @if ($order->delivery_status == 'Processed')
                                                    <td
                                                        ...
                                                        <a href="{{url('download',$order->bot)}}"
                                                            class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Download</a>
                                                    </td>
                                                @elseif ($order->delivery_status =='Cancelled!')
                                                    <td
                                                        class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                                        <button
                                                            class="px-5 py-2 border-pink-500 border text-pink-500 rounded transition duration-300 hover:bg-pink-700 hover:text-white focus:outline-none"
                                                            disabled>
                                                            Cancelled
                                                        </button>
                                                ...
                                                <td
                                                        ...
                                                        <a href="{{url('cancel_order',$order->id)}}"
                                                            class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Cancel Order</a>
                                                    </td>
                                                    @else
                                                    <td
                                                        class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                                        <p
                                                            class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Not Allowed</p>
                                                    </td>
                                                    @endif
                                            </tr>
                                        @endforeach
